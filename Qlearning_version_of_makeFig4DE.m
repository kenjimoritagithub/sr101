% Qlearning_version_of_makeFig4DE
...
for k1 = 4
    ...
    for k2 = 1:n_sim
        fprintf('%d-%d\n',k1,k2);
        out = OCD_model2_rev(type_of_learning,a{k1}(1),a{k1}(2),a{k1}(3),a{k1}(4),M_a_mode,b,n);
...
for k1 = 4
    ...
    print(F,'-depsc','QFigure4D-middle');
    %
    F = figure;
    A = axes;
    hold on
    ...
    set(A,'xtick',[0:10000:n],'xticklabel',[0:10000:n],'FontSize',28);
    set(A,'ytick',[0:0.1:1],'yticklabel',[0:0.1:1],'FontSize',28);
    print(F,'-depsc','QFigure4D-bottom');
    %
    F = figure;
    A = axes;
    hold on
    ...
    set(A,'xtick',[0:10000:n],'xticklabel',[0:10000:n],'FontSize',28);
    set(A,'ytick',[-600:200:400],'yticklabel',[-600:200:400],'FontSize',28);
    print(F,'-depsc','QFigure4E-middle');
    %
    ...
    for k2 = 1:2
        ...
        print(F,'-depsc',['QFigure4E-bottom' num2str(k2)]);
    end
end
