% Qlearning_version_of_makeFig3A-D
...
for k1 = 1:4
    ...
    print(F,'-depsc',['QFigure3' tmp_names(k1) '-top']);
    %
    F = figure;
    A = axes;
    hold on
    ...
    print(F,'-depsc',['QFigure3' tmp_names(k1) '-middle']);
    %
    F = figure;
    A = axes;
    hold on
    ...
    set(A,'xtick',[0:1000:n],'xticklabel',[0:1000:n],'FontSize',28);
    set(A,'ytick',[0:0.1:1],'yticklabel',[0:0.1:1],'FontSize',28);
    print(F,'-depsc',['QFigure3' tmp_names(k1) '-bottom']);
end
