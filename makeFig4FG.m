...
for k1 = 4
    ...
    for k2 = 1:n_sim
        fprintf('%d-%d\n',k1,k2);
        out = OCD_model_rev_decay(type_of_learning,a{k1}(1),a{k1}(2),a{k1}(3),a{k1}(4),b,n,decay_rate);
...
for k1 = 4
    ...
    set(A,'xtick',[0:10000:n],'xticklabel',[0:10000:n],'FontSize',28);
    set(A,'ytick',[-15:5:10],'yticklabel',[-15:5:10],'FontSize',28);
    print(F,'-depsc','Figure4G-middle');
    %
    ...
    for k2 = 1:2
        ...
        print(F,'-depsc',['Figure4G-bottom' num2str(k2)]);
    end
end
