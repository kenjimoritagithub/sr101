...
for k1 = 0:1:f
    ...
    for k2 = 0:1:f
        ...
        for k3 = 1:n_sim
            fprintf('%d-%d-%d\n',k1,k2,k3);
            out = OCD_model101(type_of_learning,SR_ap,SR_an,IR_ap,IR_an,b,n,n_act,decay_rate);
...
% set the same scale (color) of the image as used for Figure 4G
load('res22112600','res');
